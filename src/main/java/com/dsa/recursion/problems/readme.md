...
7. Given a Linked List, where every node represents a sub-linked-list and contains two pointers:
   ...
   ***Input*** : 
   ![Input Image](/src/main/resources/images/flatten_sorted_list_img_1.png)
